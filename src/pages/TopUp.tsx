...
const TopUp = () => {
  ...
  const accountNumber = "8123 4567 89";
            ...
            >
              ...
              <div className="flex justify-between items-start mb-8">
                ...
                <div className="text-right">
                  ...
                  <h2 className="text-sm font-bold text-white tracking-wide">Nomba MFB</h2>
                </div>
              </div>
              ...
              <div className="mb-8">
                ...
                <div className="flex items-center gap-4">
                  <span className="font-mono-custom text-3xl font-light text-white drop-shadow-[0_0_15px_rgba(210,187,255,0.2)]">
                    {accountNumber}
                  </span>
              ...
              <div className="flex justify-between items-end relative z-10">
                <div className="text-left">
                  ...
                  <p className="text-sm font-medium text-white/90 uppercase tracking-widest">Alexander Stratton</p>
                </div>
